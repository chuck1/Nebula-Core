...
namespace neb { namespace core { namespace core { namespace actor {
	...
	class base:
		...
		virtual public neb::core::game::weapon::util::parent
	{
		public:
			typedef neb::core::util::parent<neb::core::core::actor::__base, neb::core::core::actor::util::parent>		actors;
			typedef neb::core::util::parent<neb::core::core::shape::base, neb::core::core::shape::util::parent>		shapes;
		...
		public:
			virtual neb::core::math::pose					getPose() const;
			virtual neb::core::math::pose					getPoseGlobal() const;
			 ...
			 */
			virtual void						setPose(neb::core::math::pose const & pose);
		public:
			/** @brief
			 *
			 */
			virtual std::weak_ptr<neb::core::core::shape::base>		createShapeBase(
					neb::core::math::pose const & pose) = 0;
			/** @brief
			 *
			 */
